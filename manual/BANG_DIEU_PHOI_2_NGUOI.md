...
│
├── ADV-GRAPH-001: Heterogeneous Graph V2
├── ADV-GRAPH-002: Supply-chain relationships (Chuỗi cung ứng)
├── ADV-GRAPH-003: Institutional ownership relationships (Sở hữu chéo)
├── ADV-GRAPH-004: Macro / Sector node expansion
...
| :-------: | :----------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------- |
| **MỐC A** | **Đồ án Hoàn thành**<br>_(Đủ điều kiện bảo vệ)_        | • Dynamic Correlation Graph<br>• GCN Encoder<br>• Sector MARL<br>• Hierarchical MARL<br>• Backtesting & Core Ablation                                                                                              | **Cầm chắc tấm bằng tốt nghiệp.** Hệ thống chứng minh trọn vẹn giá trị của phân cấp H-MARL và đồ thị tương quan.         |
| **MỐC B** | **Đồ án Xuất sắc**<br>_(Mục tiêu điểm tối đa)_         | • Tất cả Mốc A<br>• **GAT Encoder** (Graph Attention Network)<br>• Đa hạt giống (5 Seeds: Mean $\pm$ Std)<br>• Phân tích 3 Chế độ thị trường (Bull / Bear / High-Volatility)<br>• Báo cáo kiểm toán Leakage & Bias | **Ứng viên điểm A+ / Xuất sắc.** Kết quả có ý nghĩa thống kê vượt trội, trực quan hóa được cơ chế Attention giữa các mã. |
| **MỐC C** | **Research Extension**<br>_(Hướng tới xuất bản Paper)_ | • Tất cả Mốc B<br>• Heterogeneous Graph V2 (Supply-chain + Ownership)<br>• Hetero-GNN / Hetero-GAT<br>• Cross-Agent GAT Communication (`HMARL-005`)<br>• Advanced Graph Ablation                                   | **Đạt chuẩn công bố khoa học.** Mô hình khai thác triệt để đồ thị không đồng nhất và truyền tin liên tác tử.             |
...
| **Sprint 9**<br>_(Kiểm toán khoa học & Độ vững)_     | • **EXP-011:** Bảng số liệu & Đồ thị trực quan `[CORE]`<br>• **RESEARCH-002:** Kiểm toán Leakage & Bias `[CORE]`                                                                                                                                                                                                                                                      | • **RESEARCH-003:** Model Registry & Artifacts `[CORE]`<br>• **ADV-GRAPH-001..004:** Supply-chain / Ownership Graph `[MỐC C - ADVANCED]`                                                                                                                                                                                                                    | 🤝 **EXP-010:** Đánh giá qua 3 chế độ thị trường `[MỐC B]`<br>🤝 **RESEARCH-001:** Kiểm toán so sánh công bằng với Baselines `[CORE]` | • **Code DoD:** `experiments/registry.json` lưu đủ mã commit, config, seed, weights; báo cáo xác nhận 0 lỗi leakage.<br>• **Knowledge DoD:** Cả 2 sẵn sàng trả lời phản biện về độ tin cậy của kết quả.                                                                         |
